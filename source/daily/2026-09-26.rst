...
96 项工作，并与四卡 A100、SimAI、LLMServingSim、Frontier 和 ns-3 证据逐项对照。结论是：
...
可评审 Markdown 原稿、96 项 CSV 账本和检索协议保存在仓库 ``research/`` 目录。本次补齐了
原账本缺失的 SC 主线，以及 INFOCOM 的直接 LLM serving、MLSys 的 MoE/SLO/overlap 和
NSDI/OSDI/SOSP 的近期 serving 系统。
